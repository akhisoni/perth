...
<div class="full_w">
 ...
 <?php if(!empty($InfoData['id'])){ ?>
        <img src="<?php echo PUBLICPATH."banner/".$InfoData['imagename']; ?>" width="225" height="225"  />   <?php }?>
 <div class="element">
	<span class="req">&nbsp;</span>
...
<div id="FileUpload">
 ...
 <div class="element">
	...
	<input class="field size1"  name="url" type="text"  id="name" size="35" value="<?php echo isset($InfoData['url'])?$InfoData['url']:'' ?>" />	
</div>
<div class="entry">
