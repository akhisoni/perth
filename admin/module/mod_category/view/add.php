...
<div class="full_w">
    ...
    <form action="" method="post" name="itffrminput" id="itffrminput" enctype="multipart/form-data">
        ...
        <div class="element">
            ...
            <input class="text" name="catname" type="text"  required id="catname" size="35" value="<?php echo isset($ItfInfoData['catname'])?$ItfInfoData['catname']:'' ?>" />
  ...
  <div class="element">
        <label>Category Color Code </label>
        <input class="text"  name="cat_color" type="color"  id="cat_color" size="35" value="<?php echo isset($ItfInfoData['cat_color'])?$ItfInfoData['cat_color']:'' ?>" />
    </div>
         <div class="element">
        <label>Title</label>
