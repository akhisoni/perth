    ...
    $(document).ready(function() {
        ...
        var Validator = jQuery('#itffrminput').validate({
            rules: {
                ...
                front_paging_size: {required:true, number:true},
...
<div class="full_w">
    ...
    <form action="" method="post" name="itffrminput" id="itffrminput">
        <input type="hidden" name="id" id="id" value="<?php echo isset($ItfInfoData['id'])?$ItfInfoData['id']:'' ?>" />
            ...
            <div class="element">
                <label>Front Paging Size <span class="red">(required)</span></label>
                <input class="text" name="front_paging_size" type="text"  id="front_paging_size" value="<?php echo isset($ItfInfoData['front_paging_size'])?$ItfInfoData['front_paging_size']:'' ?>" />
            </div>
