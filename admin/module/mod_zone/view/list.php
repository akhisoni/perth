...
if(isset($_POST['itf_datasid'],$_POST['itfactions']))
{
	...
	if($acts == 'delete')
	{
		...
		flash("Zone is successfully Deleted");
	}
...
$InfoData = $categoryobj->showCategoriesListAdmin();
            ...
            if(count($InfoData) > 0){
                for($i=0;$i<count($InfoData);$i++)
                {
                    ...
                    <tr>
                        ...
                        <td class="align-left"><?php echo $InfoData[$i]['zonename']; ?></td>

                        <td class="align-center">
                            <a href="#itf" class="activations" rel="<?php echo $InfoData[$i]['id']; ?>" rev="zonelist"><img src="imgs/<?php echo $InfoData[$i]['status']; ?>.png" /></a>
                        </td>
