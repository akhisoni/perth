...
$validate_fields = array('main_category'=>'','category'=>'','sub_category'=>'','product_name'=>'','price'=>'','seller_id'=>'');
...
$datas = array('name'=>$result['product_name'],'price'=>$result['price'],'seller_id'=>$result['seller_id']);
                ...
                $finalcategory = array();
               // echo "<pre>"; print_r($finalcategory); die;
                ...
                if(!empty($result['main_category']) && !empty($result['category']) && !empty($result['sub_category'])){
                    ...
                    if(!empty($result['product_code'])){
                        ...
                        $prodata = $obj->CheckProductByCode($result['product_code']);
