...
<div class="element">
	...
	<input class="text"  name="producturl" type="text"  readonly="readonly" id="producturl" size="35" value="<?php echo isset($InfoData['phone'])?$InfoData['phone']:'' ?>" />	
</div>

<div class="element">
	<span class="req">&nbsp;</span>
	<label>Subject<span>*</span></label>
	<input class="text"  name="producturl" type="text"  readonly="readonly" id="producturl" size="35" value="<?php echo isset($InfoData['message'])?$InfoData['message']:'' ?>" />	
</div>


<div class="element">
	<span class="req">&nbsp;</span>
	<label>From Page<span>*</span></label>
	<input class="text"  name="producturl" type="text"  readonly="readonly" id="producturl" size="35" value="<?php echo isset($InfoData['from_page'])?$InfoData['from_page']:'' ?>" />	
</div>
<div class="element">
	<span class="req">&nbsp;</span>
	<label>Date<span>*</span></label>
	<input class="text"  name="date_added" type="text"  id="date_added" size="35" value="<?php echo isset($InfoData['date_added'])?$InfoData['date_added']:'' ?>" />	
</div>
<div class="entry">
