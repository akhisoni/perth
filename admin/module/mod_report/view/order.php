...
$InfoData1 = $objReport->showAllEventTransactions();
                    ...
                    <tr>
                     ...
                     <td class="align-center"><?php echo $InfoData[$i]['txn_id']; ?></td>
                        ...
                        <td class="align-center"><?php echo  $InfoData[$i]['date_added']; ?></td>
                          <td class="align-center"><a href="<?php echo CreateLinkAdmin(array($currentpagenames,'actions'=>'view_detail','id'=>$InfoData[$i]['id'])); ?>" title="Show Detail" alt="Show Detail"><img src="img/i_edit.png" border="0" /></a>	  </td>
                    </tr>
                <?php
                } } else {
                ?>
