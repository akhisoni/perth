...
$InfoData1 = $objReport->showAllProductTransactions();
...
<div class="full_w"> 
  ...
  <!-- Page Heading -->
  <div class="entry top_buttons"> <a href="<?php echo CreateLinkAdmin(array('report','actions'=>'export','rep'=>'order')) ?>" class="button excel"><span>Export to excel</span></a> <a onclick="return itfsubmitfrm('delete','itffrmlists');" class="button cancel"><span>Delete</span></a> </div>
  <div class="clear"></div>
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="align-center"><?php echo $InfoData[$i]['user_email']; ?></td>
          <td class="align-center"><?php echo $InfoData[$i]['user_id']; ?></td>
          <td class="align-center"><?php echo $InfoData[$i]['payment_status']; ?></td>
          <td class="align-center"><?php echo  $InfoData[$i]['date_added']; ?></td>
          <td class="align-center"><a href="<?php echo CreateLinkAdmin(array($currentpagenames,'actions'=>'view_product_detail','id'=>$InfoData[$i]['id'])); ?>" title="Show Detail" alt="Show Detail"><img src="img/i_edit.png" border="0" /></a></td>
        </tr>
        <?php
                } } else {
                ?>
