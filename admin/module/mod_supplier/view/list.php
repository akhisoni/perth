...
if(isset($_POST['itf_datasid'],$_POST['itfactions']))
{
	...
	if($acts=='delete')
		...
		flash("Vendor is succesfully deleted");
...
{
	$InfoData1 = $userobj->ShowAllSupplier();
}
...
<div class="full_w">
    ...
    <div class="entry top_buttons">
        <!--<a href="<?php echo CreateLinkAdmin(array($currentpagenames,'actions'=>'requests')); ?>" class="button money"><span>Show all Money Requests</span></a>-->
    ...
    <form id="itffrmlists" name="itffrmlists" method="post" action="">
        ...
        <input type="hidden" name="itf_status" id="itf_status" value="" />
            ...
            <tr>
                ...
                <th scope="col" style="width: 65px;">View Events</th>
            </tr>
            </thead>
                ...
                for($i=0;$i<count($InfoData);$i++)
                {
                    ...
                    <tr>
                        ...
                        <td class="align-left"><?php echo $InfoData[$i]['email']; ?></td>
                         <td class="align-left"><?php echo $InfoData[$i]['company_name']; ?></td>
                        <td class="align-center">
                            <a href="#itf" class="activations" rel="<?php echo $InfoData[$i]['id']; ?>" rev="user"><img src="imgs/<?php echo $InfoData[$i]['status']; ?>.png" /></a>
                        </td>
                        <td class="align-center"><a href="<?php echo CreateLinkAdmin(array($currentpagenames,'actions'=>'edit','id'=>$InfoData[$i]['user_id'])); ?>" title="Edit" alt="Edit"><img src="img/i_edit.png" border="0" /></a>	  </td>
                 <td class="align-center"><a href="<?php echo CreateLinkAdmin(array($currentpagenames,'actions'=>'view_order','id'=>$InfoData[$i]['profile_id'])); ?>" title="Edit" alt="Edit"><img src="img/view.png" border="0" /></a>	 
                  </td>
                    </tr>
                <?php
                } } else {
