...
if(isset($_POST['id']))
{
	if(!empty($_POST['id']))
	{
		...
		flash("Sellers is succesfully updated");
		redirectUrl("itfmain.php?itfpage=".$currentpagenames);
	}
	else
	{
		$userobj->freeRegister($_POST);
		flash("Sellers is succesfully added");
		redirectUrl("itfmain.php?itfpage=".$currentpagenames);
	}
}
...
<div class="full_w">
    ...
    <form action="" method="post" name="itffrminput" id="itffrminput" >
       ...
       <div class="element">
        ...
        <div class="element">
            <label>Mobile / Landline No.<span class="red">(required)</span></label>
   ...
   <?php /*?>      <div class="element">
       ...
       <div class="element">
            ...
            <input class="text" name="company_state" type="text"  id="company_state" size="35" value="<?php echo isset($ItfInfoData['company_state'])?$ItfInfoData['company_state']:'' ?>" /><?php */?>
        </div>
       <!--<div class="element">
          ...
          <?php /*?><div class="element">
            <label>Company Service Areas<span class="red">(required)</span></label>
