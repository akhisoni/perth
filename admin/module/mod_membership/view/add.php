...
<div class="full_w">
    ...
    <form action="" method="post" name="itffrminput" id="itffrminput" >
        ...
        <div class="element">
            <label>Membership Type<span class="red">(required)</span></label>
             <select class="cate" name="type">
                     ...
                     <option value="Buyers"<?php if($ItfInfoData['type']=="Buyers"){echo "selected='selected'";}else{} ?>>Buyers</option>
                     <option value="Sellers"<?php if($ItfInfoData['type']=="Sellers"){echo "selected='selected'";}else{} ?>>Sellers</option>
        ...
        <div class="element">
            <label>Enter  Number of Day(s) / Month(s) / Year(s)<span class="red">(required)</span></label>
            ...
            <input class="text" name="duration_day" type="text"  id="email" size="35" value="<?php echo isset($ItfInfoData['duration_day'])?$ItfInfoData['duration_day']:'' ?>" />
             ...
             <div class="element">
            <label>Select Number of Day(s) / Month(s) / Year(s)<span class="red">(required)</span></label>
                   <select class="cate" name="duration_type">
                     <option value="">-- Select Duration --</option>
                     <option value="day"<?php if($ItfInfoData['duration_type']=="day"){echo "selected='selected'";}else{} ?>>Day(s)</option>
                     <option value="month"<?php if($ItfInfoData['duration_type']=="month"){echo "selected='selected'";}else{} ?>>Month(s)</option>
                     <option value="year"<?php if($ItfInfoData['duration_type']=="year"){echo "selected='selected'";}else{} ?>>Year(s)</option>
                    </select>
        </div>
