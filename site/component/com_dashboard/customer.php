...
<ul class="tabs" style="border-bottom:2px #b6b6b6 solid;">
    ...
    <li><a class="" href="#tab3" id="tab31">My Buying Request</a></li>
    <!--<li><a class="" href="#tab2" id="tab21">My Enquiry Catalogue</a></li>-->
...
<!--                <div class="mat">
                ...
                <div class="mat">
                        <label>Quote Details <span class="required">*</span></label>
                ...
                <div class="mat">
                    <label>Advise Delivery Area</label>
 ...
 <select class="upload" name="serviceGroup[]" id="servicecategory" multiple>
                ...
                <div class="cate">
                    ...
                    <input type="file" name="product_image" value="upload"><br>(JPG or PNG !)
                </div>
                <div class="clear"></div>
                <div class="cate">
                ...
                <th scope="col">View File</th>
                    ...
                    <td class="align-center"><?php echo $i++; ?></td>
                        <td class="align-center"><?php echo $report_info1['name']; ?></td>
                         <td class="align-center"><?php echo $report_info1['last_name']; ?></td>
                        ...
                        <td class="align-center"><?php echo $report_info1['catalog_name']; ?>
...
<!--                    <p><?php echo WordLimit($quotes['quote_desc']); ?></p>-->
                ...
                <div class="pro_name_third">
                    <p><span><?php echo $quoteobj->getQuoteStatus($bidder['bid_closed']);  ?></span></p>
...
<script type="text/javascript">
    ...
    $(function(){
        ...
        $(document).click(function(){
           //$("#detail").validate().resetForm(); 
               if($("input[name=product_image]").attr('class')=='error')
               $("input[name=product_image]").val('');
               if($("input[name=attachment]").attr('class')=='error')
        ...
        $('#detail').validate({
            rules: {
                ...
                product_image: { accept: "png|jpe?g" }
            },
            messages: {
                quantity:{number:'Accept only numeric value !'},
                attachment:{accept:"File must be PDF,DOC, JPG, XLS, GIF or PNG !"},
                product_image:{accept:"File must be JPG or PNG ! &nbsp;&nbsp;&nbsp;&nbsp;"},
