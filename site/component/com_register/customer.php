...
<section class="section">
  <div class="center_main">
    <div class="register-imge">
      <ul>
        <li>
          <h1>WELCOME TO <img src="<?php echo TemplateUrl();?>image/RegisterNowBanner.png"/> </h1>
        </li>
        <li></li>
      </ul>
    </div>
    <div class="logi-page">
      <form id="custom" name="registration" method="post" action="">
        ...
        <ul>
          ...
          <li>
            <input type="text" name="name" value="<?php echo isset($_POST['name'])?$_POST['name']:""; ?>" class="in-login">
          </li>
          <li>Last Name<span>*</span></li>
          <li>
            <input type="text" name="last_name" value="<?php echo isset($_POST['last_name'])?$_POST['last_name']:""; ?>" class="in-login">
          </li>
          <li>Email<span>*</span></li>
          <li>
            <input type="text" name="email" value="<?php echo isset($_POST['email'])?$_POST['email']:""; ?>" class="in-login">
          </li>
          <li>Username<span>*</span></li>
          <li>
            <input type="text" name="username" id="username"  value="<?php echo isset($_POST['username'])?$_POST['username']:""; ?>" class="in-login">
          </li>
          <li>Company Name</li>
          <li>
            <input type="text" name="company_name" value="<?php echo isset($_POST['company_name'])?$_POST['company_name']:""; ?>" class="in-login">
          </li>
          <li>Password<span>*</span></li>
          <li>
            <input type="password" class="in-login" name="password" id="password">
          </li>
          <li>Confirm Password<span>*</span></li>
          <li>
            <input type="password" name="verify_password" id="verify_password" class="in-login">
          </li>
          <br/>
          <li><img src="<?php echo SITEURL;?>/itf_ajax/captcha_code_file.php?rand=<?php echo rand();?>" id='captchaimg'> <br/>
          ...
          <li>
            <input id="6_letters_code" name="6_letters_code" type="text" class="in-login">
          </li>
        </ul>
        <div class="submit">
