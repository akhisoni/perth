    ...
    $(document).ready(function() {
        ...
        $('#custom').validate({
            rules: {
                ...
                //company_abn:{required:true, maxlength:100, noSpace: true},
            ...
            messages: {
                ...
                //company_abn:{required:"You must fill in all of the fields !"},
...
<p><a href="<?php echo ITFPATH; ?>">Home</a> / <a href="#">Customer and supplier Registration</a></p>
</div>
<div class="about_us"><h3>Customer and Supplier Registration</h3></div>
...
<h3>Company Details</h3>
    <div class="custom">
        <form id="custom" name="registration" method="post" action="">
            ...
            <div class="reg">
            <label>Company ABN <span class="required">&nbsp;</span></label>
