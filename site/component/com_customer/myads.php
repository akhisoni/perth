...
$report = new Product();
$report_info = $report->showAllProductFrontbyUserIdOrEmailFree($usid,$email); 
    ...
    <table class="view_request_css">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="align-center"><a href="<?php echo CreateLink(array('customer','mode'=>'details','id'=>$report_info1['id'])); ?>">View Details</a></td>
        </tr>
        <?php } ?>
      </tbody>
    </table>
