...
<script language="javascript">
      ...
      var length = document.getElementById("servicecategory").options.length;
     
      for(var i = 0;i<length;i++)
      document.getElementById("servicecategory").options[i].selected = "selected";

      //document.getElementById("servicecategory").options[0].selected = "";     
  }
   ...
   function unselectAllLocation(){
      ...
      for(var i = 0;i<length;i++)
      document.getElementById("servicecategory").options[i].selected = "";
...
<div style="display: block;" id="tab3" class="detail">
    <div class="my_categori">
        ...
        <?php if($categoriesdisplay){echo "<strong>Add Category</strong> :".$categoriesdisplay.".";}else{echo "No Category Left for selection.";}?>
    </div>
