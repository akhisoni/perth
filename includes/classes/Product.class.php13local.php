	    ...
	    foreach($params['product_detail'] as $key=>$pro){
	       ...
	       $info = array(
			...
			$message = '<table width="642" border="1" align="center" cellpadding="5" cellspacing="0">
						<tr>
						<td height="83" style="font-size:25px; background:#143e7e;">
						<a href="https://www.creaseart.com/" style="color:#FFFFFF;"><img border="0" src="https://www.creaseart.com//template/default/images/logo.png" title="Creaseart"></a></td>
						</tr>
						<tr>
						<td style=" background:#f0f0f0;"><br>
						<p>Hi creaseart Member,</p>
						<p>'.$name .', Place a order on Creaseart</p><br>
						<p>These are following detail of User</p>
						<p>Name : '.$name .' </p>
						<p>Email Id : '.$email.' </p>
						<p>&nbsp;</p>
						...
						&nbsp;&nbsp;The Creaseart Team</strong></p></td>
						 ...
						 <tr style="background:#000;">
						<td height="52" align="center" style="font-size:22px;"><a href="https://www.creaseart.com/" style="color:#fff;">Creaseart</a></td>
						</tr>
						</table>';
						//$ok = @mail($to , $subject, $message, $headers); 
						return $datas;
